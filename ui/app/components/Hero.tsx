  ...
  return (
    <>
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-48 md:pt-8">
          <div className="text-center max-w-6xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-2.5 mb-6 md:mb-8 bg-white/90 backdrop-blur-md border border-blue-200/50 rounded-full shadow-lg">
              ...
              <span className="text-xs font-medium text-gray-700 tracking-widest uppercase">
                {t("badge")}
              </span>
            </div>

            {/* Main Headline */}
            <h1 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-extralight text-white mb-6 md:mb-8 leading-[1.1] tracking-tight drop-shadow-2xl px-4">
              {t("title")}
              <br />
            ...
            {/* Subtitle */}
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 mb-8 md:mb-12 leading-relaxed font-light max-w-4xl mx-auto drop-shadow-lg px-4">
              {t("subtitle")}
            </p>
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center px-4 pb-8">
              <Link
                href="/company"
              ...
              >
                ...
                <svg
                  className="relative z-10 ml-3 w-5 h-5 transform group-hover:translate-x-1 transition-transform"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
