    ...
    <section className="pt-32 pb-24 md:pt-40 md:pb-32 bg-gradient-to-b from-white via-stone-50/20 to-white relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-24">
          ...
          <div className="w-40 h-0.5 bg-gradient-to-r from-transparent via-amber-500 to-transparent mx-auto mb-12"></div>
        </div>

        {/* Greeting Message */}
        <div className="bg-gradient-to-br from-amber-50/60 via-white to-stone-50/50 rounded-3xl border border-amber-100/60 p-12 md:p-16 mb-16 shadow-xl backdrop-blur-sm">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              <svg className="w-16 h-16 mx-auto text-amber-600/30" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <div className="w-32 h-0.5 bg-gradient-to-r from-transparent via-amber-500 to-transparent mx-auto"></div>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div
                key={activity.key}
                className="group bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 p-8 hover:shadow-2xl hover:border-amber-200/60 transition-all duration-500 transform hover:-translate-y-2"
              >
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div>
                ...
                <a 
                  ...
                  className="text-3xl font-light hover:text-amber-600 transition-colors"
                >
              ...
              <div>
                ...
                <a
                  ...
                  className="text-3xl font-light text-amber-600 hover:text-amber-500 transition-colors"
                >
